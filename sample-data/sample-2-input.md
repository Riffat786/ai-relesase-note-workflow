...
•	Date: March 15 2024
Overview
The PIC32MX470F512L is a high performance 32 bit microcontroller. We have made
several updates and improvements in this release. Users should review this
document carefully.
...
Bug Fixes
Fix for UART timeout issue when baud rate > 115200
SPI clock divider calculation corrected for edge cases
Fixed PWM deadtime insertion not working in certain configurations
USB device suspend mode now properly handled
ADC sampling inconsistency in differential mode resolved
I2C slave mode address recognition bug fixed
Known Issues
...
Certain optimization levels may cause code size issues investigate compiler
settings
