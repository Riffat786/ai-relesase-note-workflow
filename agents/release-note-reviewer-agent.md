...
- `output/release-note-[version_slug]-whats-new.md` — release notes Markdown draft

- `output/release-note-[version_slug]-whats-new.html` — release notes HTML draft
